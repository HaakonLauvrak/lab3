...
int main(int argc, char *argv[])
{
  ...
  22:	1f4080e7          	jalr	500(ra) # 212 <atoi>
  26:	89aa                	mv	s3,a0
    int pid = (argc == 3) ? atoi(argv[2]) : getpid();
  28:	478d                	li	a5,3
  2a:	04f48663          	beq	s1,a5,76 <main+0x76>
  2e:	00000097          	auipc	ra,0x0
  32:	35e080e7          	jalr	862(ra) # 38c <getpid>
  36:	85aa                	mv	a1,a0
    uint64 pa = va2pa(va, pid);
  38:	854e                	mv	a0,s3
  3a:	00000097          	auipc	ra,0x0
  3e:	38a080e7          	jalr	906(ra) # 3c4 <va2pa>
  42:	85aa                	mv	a1,a0
    printf("0x%x\n", pa);
  44:	00001517          	auipc	a0,0x1
  48:	83450513          	addi	a0,a0,-1996 # 878 <malloc+0x112>
  4c:	00000097          	auipc	ra,0x0
  50:	662080e7          	jalr	1634(ra) # 6ae <printf>
  ...
  68:	7ec50513          	addi	a0,a0,2028 # 850 <malloc+0xea>
  6c:	00000097          	auipc	ra,0x0
  70:	642080e7          	jalr	1602(ra) # 6ae <printf>
        return 0;
  74:	b7c5                	j	54 <main+0x54>
    int pid = (argc == 3) ? atoi(argv[2]) : getpid();
  76:	01093503          	ld	a0,16(s2)
  7a:	00000097          	auipc	ra,0x0
  7e:	198080e7          	jalr	408(ra) # 212 <atoi>
  82:	85aa                	mv	a1,a0
  84:	bf55                	j	38 <main+0x38>
